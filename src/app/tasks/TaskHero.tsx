...
export default function TaskHero() {
  ...
  return (
    <div className="mt-[200px] flex items-center justify-center">
      <div className="max-w-[1000px] bg-white/20 rounded-lg backdrop-blur-md border border-black p-[20px] flex flex-col gap-[10px] mb-[20px]">
          ...
          {tasks.map((item) => (
            ...
            >
              ...
              <div className="flex gap-[15px]">
                ...
                <button className="hover:text-red-500 bg-white/20 hover:bg-black/20 duration-300 rounded-md font-bold text-white cursor-pointer px-2 py-1">
                  Delete
                </button>
              </div>
            </div>
